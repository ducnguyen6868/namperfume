...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="admin_categories.php"><i class='app-menu__icon bx bx-tachometer'></i><span
      ...
      <li><a class="app-menu__item active" href="admin_users.php"><i class='app-menu__icon bx bx-purchase-tag-alt'></i><span 
